            ...
            <Container>
                {
                    user ?
                        <>
                            <H2 font='2.1875rem' top='4rem' bottom='1rem'>New uploads</H2>
                            <P bottom='4rem'>New uploads from users. Try to guess all the locations by pressing on a picture.</P>
                            <CardContainer>
                                <Card bottom='24px' />
                            </CardContainer>
                            <ButtonStyled color='white' center='center' top='1.6875rem' bottom='3.1875rem'>Load more</ButtonStyled>
                        </> :
                        <>

const theme = {
	colors: {
		...
		green: '#619b8a',
		greenLinear:
			'linear-gradient(90deg, rgba(101,158,137,1) 0%, rgba(161,193,129,1) 100%)',
		greenLinearOpacity:
			'linear-gradient(90deg, rgba(101,158,137,0.6) 0%, rgba(161,193,129,0.6) 100%)',
		orangeLinear:
			'linear-gradient(90deg, rgba(254,127,45,1) 0%, rgba(252,202,70,1) 100%)',
